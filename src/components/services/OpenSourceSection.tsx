    ...
    <section className="container py-24">
      <div className="mx-auto max-w-[58rem] text-center">
        ...
        <p className="mt-6 text-xl text-muted-foreground">
          Proprietary BYOAI tools can be costly and restrictive. We offer secure, open‑source alternatives that give you full control over your AI systems—reducing costs and boosting flexibility.
        </p>
      </div>
